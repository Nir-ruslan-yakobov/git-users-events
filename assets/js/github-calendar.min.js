...
!(function (e) {
    ...
    return (function o(s, u, i) {
        ...
        for (var l = "function" == typeof require && require, e = 0; e < i.length; e++) c(i[e]);
        return c;
    })(
        {
            1: [
                function (e, t, r) {
                    ...
                    t.exports = function (b, e, m) {
                        (b = y(b)),
                            ((m = m || {}).summary_text = m.summary_text || 'Summary of pull requests, issues opened, and commits made by <a href="https://github.com/' + e + '" target="blank">@' + e + "</a>"),
                            ...
                            return m
                                ...
                                .then(function (e) {
                                    ...
                                    y(".position-relative h2", p).remove(),
                                        (p.querySelector(".float-left.text-gray").innerHTML = m.summary_text),
                                        p.querySelector("include-fragment")
                                            ? setTimeout(g, 500)
                                            : (!0 === m.responsive &&
                                                  ((n = (r = p.querySelector("svg.js-calendar-graph-svg")).getAttribute("width")),
                                              ...
                                              !1 !== m.global_stats &&
                                                  ((s = (o = h(y("svg", p).outerHTML)).current_streak
                                                      ? M(o.current_streak_range[0], _) + " &ndash; " + M(o.current_streak_range[1], _)
                                                      : o.last_contributed
                                                      ? "Last contributed in " + M(o.last_contributed, _) + "."
                                                      : "Rock - Hard Place"),
                                                  (u = o.longest_streak
                                                      ? M(o.longest_streak_range[0], _) + " &ndash; " + M(o.longest_streak_range[1], _)
                                                      : o.last_contributed
                                                      ? "Last contributed in " + M(o.last_contributed, _) + "."
                                                      : "Rock - Hard Place"),
                                                  (i = y("<div>", {
                                                      ...
                                                      html:
                                                          ...
                                                          M(v.add(v.subtract(new Date(), 1, "year"), 1, "day"), x) +
                                                          " &ndash; " +
                                                          M(new Date(), x) +
                                                          "</span>",
                                                  })),
                                              ...
                                              !0 === m.tooltips &&
                                                  ((d = b),
                                                  (f = document.createElement("div")).classList.add("day-tooltip"),
                                                  d.appendChild(f),
                                                  d.querySelectorAll("rect.day").forEach(function (e) {
                                                      e.addEventListener("mouseenter", function (e) {
                                                          ...
                                                          var r = new Date(e.target.getAttribute("data-date")),
                                                              n = S[r.getUTCMonth()] + " " + r.getUTCDate() + ", " + r.getUTCFullYear();
                                                          (f.innerHTML = "<strong>" + t + "</strong> on " + n), f.classList.add("is-visible");
                                                          var a = e.target.getBoundingClientRect(),
                                                              o = a.left + window.pageXOffset - f.offsetWidth / 2 + a.width / 2,
                                                              s = a.bottom + window.pageYOffset - f.offsetHeight - 2 * a.height;
                                                          (f.style.top = s + "px"), (f.style.left = o + "px");
                                                      }),
                ...
                { "add-subtract-date": 2, elly: 4, formatoid: 6, "github-calendar-parser": 8 },
            ],
            2: [
                function (e, t, r) {
                    function n(a) {
            ...
            3: [
                function (e, t, r) {
                    (t.exports.en = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"]),
                        (t.exports.en.abbr = ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"]),
                        (t.exports.en.short = ["Su", "Mo", "Tu", "We", "Th", "Fr", "Sa"]),
                        (t.exports.fr = ["dimanche", "lundi", "mardi", "mercredi", "jeudi", "vendredi", "samedi"]),
                        (t.exports.fr.abbr = ["dim", "lun", "mar", "mer", "jeu", "ven", "sam"]),
                        (t.exports.fr.short = ["di", "lu", "ma", "me", "je", "ve", "sa"]),
                        (t.exports.es = ["domingo", "lunes", "martes", "miercoles", "jueves", "viernes", "sabado"]),
                        (t.exports.es.abbr = ["dom", "lun", "mar", "mir", "jue", "vie", "sab"]),
                        (t.exports.es.short = ["do", "lu", "ma", "mi", "ju", "vi", "sa"]),
                        (t.exports.it = ["Domenica", "Lunedi", "Martedi", "Mercoledi", "Giovedi", "Venerdi", "Sabato"]),
                        (t.exports.it.abbr = ["Dom", "Lun", "Mar", "Mer", "Gio", "Ven", "Sab"]),
                        (t.exports.it.short = ["D", "L", "Ma", "Me", "G", "V", "S"]),
                        (t.exports = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"]),
                        (t.exports.abbr = ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"]),
                            ...
                            e
                                ...
                                .forEach(function (e) {
                                    ...
                                    var t,
                                        ...
                                        a = a && +a[1];
                                    r &&
                                        ((t = { fill: r, date: new Date(n), count: a, level: i.indexOf(r) }),
                                        0 === s.current_streak && (s.current_streak_range[0] = t.date),
                                        t.count ? (++s.current_streak, (s.last_year += t.count), (s.last_contributed = t.date), (s.current_streak_range[1] = t.date)) : (o(), (s.current_streak = 0)),
                                        u.push(t),
                                        s.days.push(t));
                                }),
                            o(),
            ...
            9: [
                function (e, t, r) {
                    t.exports = function (e, t) {
                        var r = 0,
                            n = [];
                        if (Array.isArray(e)) for (; r < e.length && !1 !== t(e[r], r, e); ++r);
                        else if ("object" === (void 0 === e ? "undefined" : _typeof(e)) && null !== e) for (n = Object.keys(e); r < n.length && !1 !== t(e[n[r]], n[r], e); ++r);
                    };
                },
                {},
            ],
            10: [
                function (e, t, r) {
                    (t.exports = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"]),
                        (t.exports.abbr = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"]),
                        (t.exports.it = ["Gennaio", "Febbraio", "Marzo", "Aprile", "Maggio", "Giugno", "Luglio", "Agosto", "Settembre", "Ottobre", "Novembre", "Dicembre"]),
                        (t.exports.abbr.it = ["Gen", "Feb", "Mar", "Apr", "Mag", "Giu", "Lug", "Ago", "Set", "Ott", "Nov", "Dic"]),
                        (t.exports.de = ["Januar", "Februar", "März", "April", "Mai", "Juni", "Juli", "August", "September", "Oktober", "November", "Dezember"]),
                        (t.exports.abbr.de = ["Jan", "Feb", "Mär", "Apr", "Mai", "Jun", "Jul", "Aug", "Sep", "Okt", "Nov", "Dez"]);
                },
                {},
            ],
            11: [
                function (e, t, r) {
                                    ...
                                    value: function (e, t) {
                                        ...
                                        do {
                                            var n,
                                                ...
                                                o = a && a[1],
                                                s = o || e.charAt(0);
                                            o ? ("function" == typeof (n = this.obj[o]) && (n = n.apply(this, t)), (r += n)) : (r += s), (e = e.substring(s.length));
                                        } while (e);
                                        return r;
                                    },
                                },
                    ...
                    function u(e) {
                        !(function (e, t) {
                            ...
                            (this.obj = e || {}),
                            (this.re = new RegExp("^(" + Object.keys(e).map(o).join("|") + ")"));
                    }
                    function i(e, t, r) {
